          ...
          <div className="n" style={{ left: '0px', top: '0px', width: '1720px', height: '307px' }}>
            <div className="n" style={{ left: '0px', top: '0px', width: '565px', height: '307px', borderRadius: '25px', overflow: 'hidden', background: '#f8f8f8' }}>
              <div className="n" style={{ left: '25px', top: '25px', width: '80px', height: '32px' }}>
                ...
                <div className="t" style={{ left: '43px', top: '0px', width: '37px', height: '32px', fontFamily: 'var(--font-cofo)', fontSize: '25px', fontWeight: '400', lineHeight: '31.5px', letterSpacing: '-0.75px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#000000' }}>{`5.0`}</div>
              </div>
