      ...
      <div className="n" style={{ left: '101px', top: '3462px', width: '1719px', height: '750px' }}>
        ...
        <div className="n" style={{ left: '0px', top: '25px', width: '755px', height: '645px' }}>
          <div className="n" style={{ left: '0px', top: '0px', width: '515px', height: '129px' }}>
            <div className="t" style={{ left: '0px', top: '0px', width: '550px', height: '96px', outline: '1px solid rgba(255, 255, 255, 0.25)', fontFamily: 'var(--font-forma)', fontSize: '80px', fontWeight: '400', lineHeight: '96px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#ffffff' }}>{`Коричневый дом`}</div>
            <div className="n" style={{ left: '0px', top: '106px', width: '374px', height: '23px' }}>
              <div className="t" style={{ left: '0px', top: '1.5px', width: '78px', height: '20px', outline: '1px solid rgba(255, 255, 255, 0.25)', fontFamily: 'var(--font-cofo)', fontSize: '16px', fontWeight: '400', lineHeight: '20.16px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#ffffff' }}>{`3 комнаты`}</div>
              ...
              <div className="t" style={{ left: '108px', top: '1.5px', width: '108px', height: '20px', outline: '1px solid rgba(255, 255, 255, 0.25)', fontFamily: 'var(--font-cofo)', fontSize: '16px', fontWeight: '400', lineHeight: '20.16px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#ffffff' }}>{`до 6 взрослых `}</div>
              ...
              <div className="t" style={{ left: '246px', top: '1.5px', width: '108px', height: '20px', outline: '1px solid rgba(255, 255, 255, 0.25)', fontFamily: 'var(--font-cofo)', fontSize: '16px', fontWeight: '400', lineHeight: '20.16px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#ffffff' }}>{`до 10 с детьми`}</div>
            </div>
          </div>
            ...
            <div className="n" style={{ left: '0px', top: '0px', width: '755px', height: '138px' }}>
              <div className="n" style={{ left: '0px', top: '0px', width: '379px', height: '138px', borderRadius: '25px', background: '#f8f8f8' }}>
                <div className="n" style={{ left: '15px', top: '15px', width: '61px', height: '27px', borderRadius: '36px', background: '#a0f447' }}>
                  <div className="t" style={{ left: '10px', top: '4.5px', width: '41px', height: '18px', fontFamily: 'var(--font-cofo)', fontSize: '14px', fontWeight: '500', lineHeight: '17.64px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#000000' }}>{`Вс–Чт`}</div>
                </div>
                <div className="n" style={{ left: '15px', top: '51px', width: '156px', height: '69px' }}>
                  <div className="t" style={{ left: '0px', top: '0px', width: '156px', height: '48px', fontFamily: 'var(--font-forma)', fontSize: '40px', fontWeight: '400', lineHeight: '46.16px', textTransform: 'uppercase', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#000000' }}><span style={{ fontFamily: 'var(--font-forma)', fontSize: '40px', fontWeight: '400', color: '#000000' }}>{`20 000 `}</span><span style={{ fontFamily: 'var(--font-forma)', fontSize: '20px', fontWeight: '400', color: '#000000' }}>{`руб.`}</span></div>
              ...
              <div className="n" style={{ left: '384px', top: '0px', width: '370px', height: '138px', borderRadius: '25px', background: '#f8f8f8' }}>
                <div className="n" style={{ left: '15px', top: '15px', width: '61px', height: '27px', borderRadius: '36px', background: '#a0f447' }}>
                  <div className="t" style={{ left: '9px', top: '4.5px', width: '43px', height: '18px', fontFamily: 'var(--font-cofo)', fontSize: '14px', fontWeight: '500', lineHeight: '17.64px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#000000' }}>{`Пт–Сб`}</div>
                </div>
                <div className="n" style={{ left: '15px', top: '51px', width: '151px', height: '69px' }}>
                  <div className="t" style={{ left: '0px', top: '0px', width: '151px', height: '48px', fontFamily: 'var(--font-forma)', fontSize: '40px', fontWeight: '400', lineHeight: '39.8px', textTransform: 'uppercase', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#000000' }}><span style={{ fontFamily: 'var(--font-forma)', fontSize: '40px', fontWeight: '400', color: '#000000' }}>{`27 000`}</span><span style={{ fontFamily: 'var(--font-forma)', fontWeight: '400', color: '#000000' }}>{` `}</span><span style={{ fontFamily: 'var(--font-forma)', fontSize: '20px', fontWeight: '400', color: '#000000' }}>{`руб.`}</span></div>
                  <div className="t" style={{ left: '0px', top: '48px', width: '64px', height: '21px', fontFamily: 'var(--font-cofo)', fontSize: '17px', fontWeight: '400', lineHeight: '21.42px', display: 'grid', alignContent: 'start', textAlign: 'left', color: 'rgba(0, 0, 0, 0.4)' }}>{`за сутки`}</div>
                </div>
          ...
          <div className="n" style={{ left: '0px', top: '605px', width: '323px', height: '40px' }}>
            ...
            <div className="t" style={{ left: '27px', top: '0px', width: '296px', height: '40px', fontFamily: 'var(--font-cofo)', fontSize: '16px', fontWeight: '400', lineHeight: '20.16px', display: 'grid', alignContent: 'start', textAlign: 'left', color: '#ffffff' }}>{`3 спальни с двухспальными кроватями. Баня доступна дополнительно.`}</div>
          </div>
        </div>
      </div>
