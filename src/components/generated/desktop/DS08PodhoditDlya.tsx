...
/** block · fi-ss-angle-double-small-right
 *  y 7369 → 8422 (1053px) */
export function DS08PodhoditDlya() {
  return (
    <>
      <div className="n" style={{ left: '99px', top: '7369px', width: '1721px', height: '966px' }}>
        <div className="n" style={{ left: '1px', top: '273px', width: '1720px', height: '693px', borderRadius: '95px' }}>
          <div className="n" style={{ left: '0px', top: '0px', width: '421px', height: '579px', borderRadius: '95px', overflow: 'hidden', background: '#f8f8f8' }}>
            ...
            <div className="n" style={{ left: '49px', top: '429px', width: '323px', height: '103px' }}>
              ...
              <div className="t" style={{ left: '0px', top: '40px', width: '323px', height: '63px', fontFamily: 'var(--font-cofo)', fontSize: '17px', fontWeight: '400', lineHeight: '21.42px', display: 'grid', alignContent: 'start', textAlign: 'center', color: 'rgba(0, 0, 0, 0.4)' }}>{`До 10 человек с детьми — бассейн, костёр, безопасная территория 
и простор для игр.`}</div>
            </div>
          </div>
          <div className="n" style={{ left: '433px', top: '114px', width: '421px', height: '579px', borderRadius: '95px', overflow: 'hidden', background: '#f8f8f8' }}>
            ...
            <div className="n" style={{ left: '72.94px', top: '429px', width: '277px', height: '82px' }}>
              ...
              <div className="t" style={{ left: '0px', top: '40px', width: '277px', height: '42px', fontFamily: 'var(--font-cofo)', fontSize: '17px', fontWeight: '400', lineHeight: '21.42px', display: 'grid', alignContent: 'start', textAlign: 'center', color: 'rgba(0, 0, 0, 0.4)' }}>{`Чан под звёздами, тишина, свой бассейн — никаких соседей рядом.`}</div>
            </div>
          </div>
          <div className="n" style={{ left: '866px', top: '0px', width: '421px', height: '579px', borderRadius: '95px', overflow: 'hidden', background: '#f8f8f8' }}>
            ...
            <div className="n" style={{ left: '72px', top: '429px', width: '277px', height: '82px' }}>
              ...
              <div className="t" style={{ left: '0px', top: '40px', width: '277px', height: '42px', fontFamily: 'var(--font-cofo)', fontSize: '17px', fontWeight: '400', lineHeight: '21.42px', display: 'grid', alignContent: 'start', textAlign: 'center', color: 'rgba(0, 0, 0, 0.4)' }}>{`Свой дом, мангал, беседка — отмечайте как хотите, без чужих.`}</div>
            </div>
          </div>
          <div className="n" style={{ left: '1299px', top: '114px', width: '421px', height: '579px', borderRadius: '95px', overflow: 'hidden', background: '#f8f8f8' }}>
            ...
            <div className="n" style={{ left: '72px', top: '429px', width: '277px', height: '103px' }}>
              ...
              <div className="t" style={{ left: '0px', top: '40px', width: '277px', height: '63px', fontFamily: 'var(--font-cofo)', fontSize: '17px', fontWeight: '400', lineHeight: '21.42px', display: 'grid', alignContent: 'start', textAlign: 'center', color: 'rgba(0, 0, 0, 0.4)' }}>{`Два дома рядом — до 12 взрослых или 20 с детьми. Своя территория у каждой группы.`}</div>
            </div>
          </div>
        </div>
